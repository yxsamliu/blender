...
set BUILD_CMAKE_ARGS=%BUILD_CMAKE_ARGS% -DWITH_CYCLES_ONEAPI_BINARIES=OFF -DWITH_CYCLES_HIP_BINARIES=ON -DWITH_CYCLES_CUDA_BINARIES=OFF -DWITH_CYCLES_DEVICE_ONEAPI=OFF
:EOF
exit /b 0
:ERR
exit /b 1
